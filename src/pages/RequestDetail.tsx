...
import { AlertTriangle, ArrowLeft, Check, Clock, ExternalLink, Image, Layers, Mail, MessageCircleQuestion, MessageSquare, Paperclip, Pencil, Reply, Send, Trash2, X } from 'lucide-react'
